...
-- ----------------------------
INSERT INTO `sys_oss_setting` VALUES (1, 'http://127.0.0.1:9000', 'minio', 'your-access-key', 'your-secret-key', 'test', 'http://127.0.0.1:9000', '', '2024-11-27 16:31:05', 1, NULL);
...
-- ----------------------------
INSERT INTO `sys_param` VALUES ('d5edaee45f02569fa31bb1f464d24c1b', '系统登录时的超级验证码，enable：开关，code：具体验证码', 'sys_super_code', '{\"enable\":false,\"code\":\"\"}', '2025-10-16 11:50:09', '系统登录验证码', '', 1, '2025-10-16 11:50:09');
