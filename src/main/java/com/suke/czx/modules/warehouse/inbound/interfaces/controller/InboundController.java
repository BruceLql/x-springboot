...
import com.suke.czx.modules.warehouse.inbound.interfaces.dto.command.BatchInboundCommand;
...
public class InboundController extends AbstractController {
    ...
    public R items(@PathVariable String orderId) {
        List<InboundItemVO> items = inboundApplicationService.getItems(orderId);
    ...
    public R batchInbound(@RequestBody BatchInboundCommand command) {
